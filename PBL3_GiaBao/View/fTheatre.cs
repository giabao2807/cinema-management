...
{
    public partial class fTheatre : Form
    {
        ...
        public fTheatre(LichChieu lichchieu, Phim phim)
        {
            InitializeComponent();
            Times = lichchieu;
            Movie = phim;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                foreach (Button btn in listSeatSelected)
                {
                    ...
                    ret += BLL_Ve.Instance.BuyTicket(ticket.id,TienBanVe);
                }
        ...
        {
            using (QLRP7Entities db = new QLRP7Entities())
            {
